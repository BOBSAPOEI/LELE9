...
anggota2 = Anggota("Gita jasmine", "A002")

anggota1.pinjam_buku(buku1)  # Satria pinjam buku1
anggota1.pinjam_buku(buku2)  # Satria pinjam buku2

anggota2.pinjam_buku(buku1)  # Gita jasmine coba pinjam buku1 (gagal)

anggota1.kembalikan_buku(buku1)  # Satria kembalikan buku1

anggota2.pinjam_buku(buku1)  # Gita jasmine sekarang bisa pinjam buku1
