            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 lg:w-1/2">
                    ...
                    <div class="flex items-center">
                        <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:bg-primary hover:text-red-500 dark:text-black"><img src="/img/whatsapp.jpg" alt=""></a>
                        <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:bg-primary hover:text-red-500 dark:text-black"><img src="/img/instagram.png" alt=""></a>
                        <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:bg-primary hover:text-red-500 dark:text-black"><img src="/img/pornhub.png" alt=""></a>
                        <a href="#" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:bg-primary hover:text-red-500 dark:text-black"><img src="/img/tik-tok.png" alt=""></a>
                    </div>
